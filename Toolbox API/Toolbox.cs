    ...
    class Toolbox
    {
        ...
        public void setName(string newName)
        {
            ...
            else
            {
                ...
                {
                    Directory.Move(getToolboxesPath() + this.name, getToolboxesPath() + newName);
                }
                oldName = name;
                name = newName;
            }
        ...
        public void save()
        {
            if (!Directory.Exists(getToolboxesPath() + this.name))
            {
                Directory.CreateDirectory(getToolboxesPath() + this.name);
            }

            if (this.icon != null) { this.icon.Save(getToolboxesPath() + this.name + "/icon.png"); }
            toolbox2xml(this, getToolboxesPath() + this.name + "/toolbox.xml");
        }
        ...
        private string getToolboxesPath()
        {
